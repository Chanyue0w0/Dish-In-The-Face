...
public class LoadScenePanel : MonoBehaviour
{
	...
	[SerializeField] private Image fillImage;          // 進度條 (Image type 設成 Filled)
	[SerializeField] private TextMeshProUGUI progressText;        // 百分比文字（可選）

	private void Awake()
	{
		loadingPanel.SetActive(false); // 遊戲一開始關閉
		fillImage.fillAmount = 0f;
	}

	/// <summary>
	/// 呼叫此功能 → 顯示 loading panel 並開始載入
	/// </summary>
	...
	private IEnumerator LoadSceneAsync(string sceneName)
	{
		...
		{
			// Unity 的 progress 最大到 0.9，剩下 0.1 是激活場景
